defmodule SardineRun.Config.Schema do
  @moduledoc false
  ...
  defmodule Workspace do
    ...
    @primary_key false
    embedded_schema do
      field(:root, :string, default: Path.join(System.tmp_dir!(), "sardine_run_workspaces"))
    end
  ...
  defp finalize_settings(settings) do
    ...
    workspace = %{
      settings.workspace
      | root: resolve_path_value(settings.workspace.root, Path.join(System.tmp_dir!(), "sardine_run_workspaces"))
    }
  ...
  defp expand_local_workspace_root(_workspace_root) do
    Path.expand(Path.join(System.tmp_dir!(), "sardine_run_workspaces"))
  end
