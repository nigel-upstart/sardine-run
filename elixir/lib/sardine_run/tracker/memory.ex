defmodule SardineRun.Tracker.Memory do
  @moduledoc """
  ...
  defp configured_issues do
    Application.get_env(:sardine_run, :memory_tracker_issues, [])
  end
  ...
  defp send_event(message) do
    case Application.get_env(:sardine_run, :memory_tracker_recipient) do
